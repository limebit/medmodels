...
class PyMedRecord:
    ...
    def node(self, node_index: List[NodeIndex]) -> Dict[NodeIndex, Attributes]: ...
    def edge(self, edge_index: List[EdgeIndex]) -> Dict[EdgeIndex, Attributes]: ...
    ...
    def replace_node_attributes(
        self, attributes: Attributes, node_index: List[NodeIndex]
    ) -> None: ...
    def update_node_attribute(
        self,
        attribute: MedRecordAttribute,
        value: MedRecordValue,
        node_index: List[NodeIndex],
    ) -> None: ...
    def remove_node_attribute(
        self, attribute: MedRecordAttribute, node_index: List[NodeIndex]
    ) -> None: ...
