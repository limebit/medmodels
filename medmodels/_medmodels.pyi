...
class PyNodeAttributeOperand:
    ...
    def is_in(
        self, operands: List[MedRecordValue]
    ) -> PyNodeOperation: ...  # TODO: operands -> values
    ...
    def round(self, value: MedRecordValue) -> ValueOperand: ...
    def ceil(self, value: MedRecordValue) -> ValueOperand: ...
    def floor(self, value: MedRecordValue) -> ValueOperand: ...
    def trim(self, value: MedRecordValue) -> ValueOperand: ...
    def trim_start(self, value: MedRecordValue) -> ValueOperand: ...
    def trim_end(self, value: MedRecordValue) -> ValueOperand: ...
    def lowercase(self, value: MedRecordValue) -> ValueOperand: ...
    def uppercase(self, value: MedRecordValue) -> ValueOperand: ...
