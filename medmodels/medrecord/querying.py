...
class NodeOperand:
    ...
    def either_or(self, either: NodeQuery, or_: NodeQuery) -> None:
        ...
        It applies the combination of the two queries to the node query. It
        returns all nodes that satisfy either the first query or the second query.
...
class EdgeOperand:
    ...
    def either_or(self, either: EdgeQuery, or_: EdgeQuery) -> None:
        ...
        It applies the combination of the two queries to the edge query. It
...
class MultipleValuesOperand:
    """Query API for multiple values in a MedRecord."""
    ...
    def either_or(
        ...
        It applies the combination of the two queries to the multiple values query. It
        returns all multiple values that satisfy either the first query or the second
        query.

        Example:
        ```python
        multiple_values_operand.either_or(
            lambda values: values.is_int(),
            lambda values: values.is_float()
        )
        ```
...
class SingleValueOperand:
    ...
    def modulo(self, value: SingleValueArithmeticOperand) -> None:
        """Get the modulo of the single value by a value.
    ...
    def power(self, value: SingleValueArithmeticOperand) -> None:
        ...
        Args:
            value (SingleValueArithmeticOperand): The power to raise the single value to.
        """
    ...
    def either_or(
        ...
        It applies the combination of the two queries to the single value query. It
        returns the single value if it satisfies either the first query or the second
        query.
        ...
        single_value_operand.either_or(
            lambda value: value.is_int(),
            lambda value: value.is_float()
        )
...
class AttributesTreeOperand:
    """Query API for multiple attributes pertaining to multiple nodes/edges.
    ...
    def max(self) -> MultipleAttributesOperand:
        """Query the attribute name with the maximum value across all nodes/edges.

        Returns:
            MultipleAttributesOperand: The attribut name with the maximum value across
                all nodes/edges.
        """
    ...
    def min(self) -> MultipleAttributesOperand:
        """Query the attribute name with the minimum value across all nodes/edges.

        Returns:
            MultipleAttributesOperand: The attribut name with the minimum value across
                all nodes/edges.
        """
        return MultipleAttributesOperand._from_py_multiple_attributes_operand(
    ...
    def count(self) -> MultipleAttributesOperand:
        """Query the number of attributes each node/edge has.

        Returns:
            MultipleAttributesOperand: The number of attributes each node/edge has.
        """
        return MultipleAttributesOperand._from_py_multiple_attributes_operand(
    ...
    def sum(self) -> MultipleAttributesOperand:
        """Query the sum of the names of the attributes across all nodes/edges.

        Returns:
            MultipleAttributesOperand: The sum of the attribute names across all
                nodes/edges.
        """
        return MultipleAttributesOperand._from_py_multiple_attributes_operand(
    ...
    def first(self) -> MultipleAttributesOperand:
        """Get the first value of the attribute names across all nodes/edges.

        Returns:
            MultipleAttributesOperand: The first value of the attribute names across all
                nodes/edges.
        """
        return MultipleAttributesOperand._from_py_multiple_attributes_operand(
    ...
    def last(self) -> MultipleAttributesOperand:
        """Get the last value of the attribute names across all nodes/edges.

        Returns:
            MultipleAttributesOperand: The last value of the attribute names across all
                nodes/edges.
        """
        return MultipleAttributesOperand._from_py_multiple_attributes_operand(
    ...
    def is_string(self) -> None:
        """Query which attribute names are strings."""
        self._attributes_tree_operand.is_string()

    def is_int(self) -> None:
        """Query which attribute names are integers."""
        self._attributes_tree_operand.is_int()

    def is_max(self) -> None:
        """Query which attribute names are the maximum value."""
        self._attributes_tree_operand.is_max()

    def is_min(self) -> None:
        """Query which attribute names are the minimum value."""
        self._attributes_tree_operand.is_min()

    def greater_than(self, attribute: SingleAttributeComparisonOperand) -> None:
        """Query which attribute names are greater than a value.
    ...
    def is_in(self, attributes: MultipleAttributesComparisonOperand) -> None:
        ...
        Args:
            attributes (MultipleAttributesComparisonOperand): The list of values to
                compare against across all nodes/edges.
        """
    ...
    def starts_with(self, attribute: SingleAttributeComparisonOperand) -> None:
        """Query whether any of the attributes start with a value.
    ...
    def ends_with(self, attribute: SingleAttributeComparisonOperand) -> None:
        """Query whether any of the attributes end with a value.
    ...
    def contains(self, attribute: SingleAttributeComparisonOperand) -> None:
        """Query whether any of the attributes contain a value.
    ...
    def add(self, attribute: SingleAttributeArithmeticOperand) -> None:
        """Add a value to all attribute names.

        Args:
            attribute (SingleAttributeArithmeticOperand): The value to add across all
                nodes/edges for the attribute names.
        """
    ...
    def modulo(self, attribute: SingleAttributeArithmeticOperand) -> None:
        """Get the modulo of the attribute names by a value.

        In mathematics and computer science, the modulo operation finds the remainder
        after division of one number by another.

        Args:
            attribute (SingleAttributeArithmeticOperand): The value to get the modulo
                by.
        """
    ...
    def either_or(
        ...
        """Apply either-or logic to the current attribute names query.

        It applies the combination of the two queries to the attribute names query. It
        returns all attribute names that satisfy either the first query or the second
        query.
        ...
        attributes_tree_operand.either_or(
            lambda attributes: attributes.is_int(),
            lambda attributes: attributes.is_float()
        )

        ```

        Args:
            either (Callable[[AttributesTreeOperand], None]): One of the queries to
                apply.
            or_ (Callable[[AttributesTreeOperand], None]): The other query to apply.
        """
    ...
    def clone(self) -> AttributesTreeOperand:
        """Create a deep clone of the current attribute names query.

        Returns:
            AttributesTreeOperand: A deep clone of the current attribute names query.
        """
        return AttributesTreeOperand._from_py_attributes_tree_operand(
...
class MultipleAttributesOperand:
    """Query API for one attribute across multiple nodes/edges.

    This operand is used to query on multiple attributes, returning a single attribute.
    """
    _multiple_attributes_operand: PyMultipleAttributesOperand

    def max(self) -> SingleAttributeOperand:
        """Query the attribute from a node/edge with the maximum name.

        Returns:
            SingleAttributeOperand: The maximum attribute name across all
                nodes/edges for that attribute.
        """
    ...
    def min(self) -> SingleAttributeOperand:
        """Query the attribute with the minimum value.

        Returns:
            SingleAttributeOperand: The minimum value of the attributes.
        """
        return SingleAttributeOperand._from_py_single_attribute_operand(
    ...
    def count(self) -> SingleAttributeOperand:
        """Query the number of attributes nodes have.

        Returns:
            SingleAttributeOperand: The number of attributes nodes have.
        """
        return SingleAttributeOperand._from_py_single_attribute_operand(
    ...
    def sum(self) -> SingleAttributeOperand:
        """Query the sum of the names of the attributes.

        Returns:
            SingleAttributeOperand: The sum of the attribute names.
        """
        return SingleAttributeOperand._from_py_single_attribute_operand(
    ...
    def first(self) -> SingleAttributeOperand:
        """Get the first value of the attribute names.

        Returns:
            SingleAttributeOperand: The first value of the attribute names.
        """
        return SingleAttributeOperand._from_py_single_attribute_operand(
...
class SingleAttributeOperand:
    ...
    def modulo(self, attribute: SingleAttributeArithmeticOperand) -> None:
        """Get the modulo of the single attribute name by a value.
    ...
    def either_or(
        ...
        It applies the combination of the two queries to the single attribute name query.
        It returns the single attribute name if it satisfies either the first query or
        the second query.
...
class NodeIndicesOperand:
    ...
    def modulo(self, index: NodeIndexArithmeticOperand) -> None:
        """Get the modulo of the node indices by a value.

        In mathematics and computer science, the modulo operation finds the remainder
        after division of one number by another.

        Args:
            index (NodeIndexArithmeticOperand): The value to get the modulo by.
        """
    ...
    def either_or(
        ...
        It applies the combination of the two queries to the node indices query. It
        returns all node indices that satisfy either the first query or the second query.
...
class NodeIndexOperand:
    ...
    def modulo(self, index: NodeIndexArithmeticOperand) -> None:
        """Get the modulo of the node index by a value.
    ...
    def either_or(
        ...
        It applies the combination of the two queries to the node index query. It
        returns all node indices that satisfy either the first query or the second query.
        ...
        node_index_operand.either_or(
            lambda node_index: node_index.is_int(),
            lambda node_index: node_index.is_float()
        )
...
class EdgeIndicesOperand:
    ...
    def modulo(self, index: EdgeIndexArithmeticOperand) -> None:
        """Get the modulo of the edge indices by a value.

        In mathematics and computer science, the modulo operation finds the remainder
        after division of one number by another.

        Args:
            index (EdgeIndexArithmeticOperand): The value to get the modulo by.
        """
    ...
    def either_or(
        ...
        It applies the combination of the two queries to the edge indices query. It
        returns all edge indices that satisfy either the either query or the or query.
...
class EdgeIndexOperand:
    ...
    def either_or(
        ...
        It applies the combination of the two queries to the edge index query. It
        returns the edge index if is satisfies either the either query or the or query.
