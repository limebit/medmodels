...
At this place, some badges will be implemented. 
...
## What is MedModels? 
MedModels is a Python-based software framework for the analysis of real-world evidence data for the health care sector. MedModels makes complex analyses and predictions based on medical data significantly faster, more precise, reliable, and more cost-effective. 
...
MedModels is aimed at a wide range of users, including pharmaceutical companies, health research institutes, and health insurance companies. 
...
* **Patient Matching**
<br/> Statistical methods as well as innovative machine learning algorithms help identify similar patients in treatment and control groups.
...
<br/> Medical concpet embeddings pre-process medical raw data into compact representations that depict temporal and causal relationships of the concepts (diagnosis, treatment, medications, ...).
* **Predictive Modeling**
<br/> Machine learning models predict medical target variables (diagnostics, events, treatment chances, ...) based on EHR data. 
* **Explainable AI** 
