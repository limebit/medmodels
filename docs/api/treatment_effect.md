# Treatment Effect Module Overview

The `TreatmentEffect` module is designed for analyzing treatment effects within medical records. The module has the following submodules:
